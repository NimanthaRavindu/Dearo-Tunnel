...
import {ArrowLeft,Wallet,Coins,Building2,TrendingUp,TrendingDown,ChevronRight,Sparkles,Fuel} from "lucide-react";
  ...
  const expenseCategories = [
    {
      ...
      iconBg:
        "group-hover:bg-cyan-500/10 group-hover:border-cyan-500/30 group-hover:text-cyan-400",
    ...
    },
    {
      ...
      iconBg:
        "group-hover:bg-purple-500/10 group-hover:border-purple-500/30 group-hover:text-purple-400",
    ...
    },
    {
      ...
      iconBg:
        "group-hover:bg-red-500/10 group-hover:border-red-500/30 group-hover:text-red-400",
    ...
    },
    {
      ...
      title: "Sales Income",
      description:
        "Record and manage daily cash sales, incoming revenue streams, and customer payment collections for the branch.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      iconBg:
        "group-hover:bg-amber-500/10 group-hover:border-amber-500/30 group-hover:text-amber-400",
    ...
    // -------------------------------------------------
    {
      ...
      description:
        "Track diesel consumption, machine-wise fuel usage, total payable amounts, payments, and outstanding balances.",
      icon: Fuel,
      hoverBorder: "hover:border-blue-500/50",
      hoverShadow: "hover:shadow-blue-500/10",
      iconBg:
        "group-hover:bg-blue-500/10 group-hover:border-blue-500/30 group-hover:text-blue-400",
          ...
          {expenseCategories.map((item) => {
            ...
            return (
              <button
                ...
                onClick={() =>
                  router.push(
                    `/dashboard/branches/${id}/add-expenses/${item.id}`
                  )
                }
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`p-3.5 rounded-xl bg-slate-900/90 border border-slate-800/80 text-slate-400 ${item.iconBg} transition-all duration-300 shrink-0`}
                >
