...
import { DollarSign,Calendar,User,PlusCircle,TrendingUp,CreditCard,ArrowLeft,Trash2,Loader2,Receipt,Search,Filter} from "lucide-react";
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-800/80 pb-3 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-sm font-semibold text-slate-200">Expense Logs</h2>
